...
export class DetailIngenieurComponent implements OnInit {
  ...
  ingenieur:any
  competence:any
  constructor(private activeRoute: ActivatedRoute,private api: IngenieurService, private apidata:CompetenceService) { }
  ...
  getOneClient(){
    this.api.getingenieur(this.id).subscribe((res:any)=>{
    this.ingenieur=res
